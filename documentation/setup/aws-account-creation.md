...
The format I will be using is `example+resumegeneral@email.com` for my *Root user email address* and `example-cloud-resume-general` for my *AWS account name*.
...
### Step 2a: Adding Mult-Factor Authentication (MFA)
